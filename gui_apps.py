...
class _ChatColonne(QWidget):
    ...
    def __init__(self, titre: str, accent: str):
        ...
        titre_w.setStyleSheet("font-weight: 600; color: #22c55e; font-size: 13px; background: transparent;")
        h.addWidget(titre_w)
        h.addStretch(1)
        ...
        self._send.setStyleSheet(
            ...
            "}"
            "QPushButton:hover { background-color: #86efac; border-color: #86efac; }"
    ...
    def ajouter_systeme(self, texte: str):
        bulle = QLabel(texte)
        bulle.setStyleSheet(
            "color: #86efac; font-style: italic; font-size: 11px; padding: 2px;"
        )
...
class TcpChatPanel(QWidget):
    ...
    def __init__(self):
        ...
        self._col_serveur = _ChatColonne("Serveur", accent="#86efac")
...
class BluetoothChatPanel(QWidget):
    ...
    def __init__(self):
        ...
        self._col_serveur = _ChatColonne("Serveur", accent="#22c55e")
        self._col_serveur.connecter_envoi(self._envoyer_serveur)
        self._col_serveur.activer(False)
        ...
        self._col_client = _ChatColonne("Client", accent="#86efac")
        self._col_client.connecter_envoi(self._envoyer_client)
        self._col_client.activer(False)
