"""Lanceur d'implementations de cryptographie.

Interface en ligne de commande miroir de la disposition de l'interface graphique de bureau :
- En-tete de marque en bleu francais.
- Modules groupes par theme, affiches sous la forme d'une liste de style barre laterale.
- Choix par module entre le scenario predefinit et le
  formulaire interactif 'Tester avec mes valeurs' (memes SPECS que la GUI).
"""
import importlib
import sys
...
if __name__ == "__main__":
    from locker.cli import main as locker_main
